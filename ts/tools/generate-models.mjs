...
const NAMED_DEF_SCHEMAS = {
  ...
  "afbws/instrument.channel.v1.json": {
    ...
    collectionMembersEdit: "InstrumentCollectionMembersEdit",
  ...
  "afbws/market.channel.v1.json": {
    ...
    subscriptionSnapshotSpec: "MarketSubscriptionSnapshotSpec",
    subscriptionSeriesSpec: "MarketSubscriptionSeriesSpec",
