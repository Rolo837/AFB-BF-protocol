...
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsTradeplanListItem".
 */
export type SettingsTradeplanListItem = TradePlanV1 | TradePlanV2;
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "DashboardSettings".
 */
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "DashboardLayoutItem".
 */
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "DatasetSettings".
 */
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "IndicatorSettings".
 */
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "InterfaceSettings".
 */
export interface InterfaceSettings {
  ...
  chart_toolbar?: InterfaceChartToolbar;
  services_filters?: InterfaceServicesFilters;
  trade_plan_default_capital_rub?: number;
  [k: string]: unknown;
}
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "InterfaceChartToolbar".
 */
export interface InterfaceChartToolbar {
  ...
  /**
   * ChartPrimitive kind values (settings/primitive.v1.json#kind).
   */
...
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "InterfaceServicesFilters".
 */
export interface InterfaceServicesFilters {
  instruments?: {
    markets?: string[];
    [k: string]: unknown;
  };
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsLimits".
 */
export interface SettingsLimits {
  max_favorites_tickers?: number;
  max_primitives_per_user?: number;
  [k: string]: unknown;
}
/**
...
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsRejectedEnvelope".
 */
export interface SettingsRejectedEnvelope {
  rejected: true;
  message: string;
  [k: string]: unknown;
}
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsGetDefaultRequest".
 */
export interface SettingsGetDefaultRequest {
  type?: 'get_default';
  [k: string]: unknown;
}
/**
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsDefaultPayload".
 */
export interface SettingsDefaultPayload {
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "ServiceSettings".
 */
...
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsDefaultPush".
 */
export interface SettingsDefaultPush {
  type: 'default';
...
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsGetRequest".
 */
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsSetRequest".
 */
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "UserSettingsFile".
 */
export interface UserSettingsFile {
  ...
  indicators?: IndicatorSettings[];
  /**
   * secid strings; hydrated to SecurityInstrument objects on the wire (settings_payload.v1.json).
   */
  favorites?: string[];
  alarms?: AlarmV1[];
  tradeplans?: (TradePlanV1 | TradePlanV2)[];
  /**
   * Keyed by secid (uppercased on save).
   */
  primitives?: {
    [k: string]: ChartPrimitive[];
  };
  trade?: TradeSettings;
  /**
   * Display name, mirrored from config/users.yaml.
   */
  name?: string;
  [k: string]: unknown;
}
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "ChartPrimitive".
 */
export interface ChartPrimitive {
  id?: string;
  kind?: 'line' | 'line_enter' | 'line_sl' | 'line_tp' | 'note' | 'zone' | 'ruler';
  start?: PrimitivePoint;
  stop?: PrimitivePoint1;
  /**
   * note only.
   */
  text?: string;
  used_in_tradeplans?: boolean;
  [k: string]: unknown;
}
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "PrimitivePoint".
 */
...
/**
 * Second anchor — zone/ruler only; absent for line* /note.
 */
export interface PrimitivePoint1 {
  /**
   * Unix seconds, as in klines.
   */
  time?: number;
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "TradeSettings".
 */
export interface TradeSettings {
  ...
  notify?: TradeNotifySettings;
  chart_deal_markers?: boolean;
  [k: string]: unknown;
}
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "TradeNotifySettings".
 */
export interface TradeNotifySettings {
  trigger?: boolean;
...
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsPush".
 */
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "UserSettingsPayload".
 */
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SecurityInstrument".
 */
export interface SecurityInstrument {
  ...
  /**
   * Underlying asset code, futures only.
   */
  asset?: string | null;
  /**
   * Margin requirement, futures only.
   */
  margin?: number | null;
  lotsize?: number | null;
  step?: number | null;
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsSetDefaultRequest".
 */
export interface SettingsSetDefaultRequest {
  type: 'set_default';
  data: {
    dataset: DatasetSettings;
    interface?: InterfaceSettings;
...
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsGetAlarmsRequest".
 */
export interface SettingsGetAlarmsRequest {
  type?: 'get_alarms';
  [k: string]: unknown;
}
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsSetAlarmsRequest".
 */
export interface SettingsSetAlarmsRequest {
  type: 'set_alarms';
  data: AlarmV1[];
  [k: string]: unknown;
}
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsAlarmsPush".
 */
export interface SettingsAlarmsPush {
  type: 'alarms';
  data: AlarmV1[];
  [k: string]: unknown;
}
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsUpdateAlarmRequest".
 */
export interface SettingsUpdateAlarmRequest {
  type: 'update_alarm';
  alarm_id: string;
  data: AlarmV1;
  [k: string]: unknown;
...
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsAlarmUpdatedPush".
 */
export interface SettingsAlarmUpdatedPush {
  type: 'alarm_updated';
  data: AlarmV1;
  [k: string]: unknown;
}
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsGetPlansRequest".
 */
export interface SettingsGetPlansRequest {
  type?: 'get_plans';
  [k: string]: unknown;
}
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsSetPlansRequest".
 */
export interface SettingsSetPlansRequest {
  type: 'set_plans';
...
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsPlansPush".
 */
export interface SettingsPlansPush {
  type: 'plans';
  data: SettingsTradeplanListItem[];
  [k: string]: unknown;
}
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsUpdatePlanRequest".
 */
export interface SettingsUpdatePlanRequest {
  type: 'update_plan';
  plan_id: string;
  data: SettingsTradeplanListItem;
  [k: string]: unknown;
...
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsPlanAmendResult".
 */
export interface SettingsPlanAmendResult {
  deal_id?: string;
  accepted?: boolean;
  message?: string;
  [k: string]: unknown;
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsPlanUpdatedPush".
 */
export interface SettingsPlanUpdatedPush {
  type: 'plan_updated';
  data: SettingsTradeplanListItem;
  amend?: SettingsPlanAmendResult[];
  [k: string]: unknown;
}
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsGetFavoritesRequest".
 */
export interface SettingsGetFavoritesRequest {
  type?: 'get_favorites';
  [k: string]: unknown;
}
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsSetFavoritesRequest".
 */
export interface SettingsSetFavoritesRequest {
  type: 'set_favorites';
  tickers: string[];
  [k: string]: unknown;
}
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsFavoritesPush".
 */
export interface SettingsFavoritesPush {
  type: 'favorites';
  data: {
    [k: string]: SecurityInstrument;
  }[];
...
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsGetPrimitivesRequest".
 */
export interface SettingsGetPrimitivesRequest {
  type?: 'get_primitives';
  [k: string]: unknown;
}
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsPrimitivesBySecid".
 */
export interface SettingsPrimitivesBySecid {
  [k: string]: ChartPrimitive[];
}
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsSetPrimitivesRequest".
 */
export interface SettingsSetPrimitivesRequest {
  type: 'set_primitives';
 ...
 *
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsPrimitivesPush".
 */
export interface SettingsPrimitivesPush {
  type: 'primitives';
  data: SettingsPrimitivesBySecid;
  warning?: string;
  [k: string]: unknown;
...
/**
 * This interface was referenced by `_GeneratedRoot`'s JSON-Schema
 * via the `definition` "SettingsErrorPush".
 */
export interface SettingsErrorPush {
  type: 'error';
  message: string;
  [k: string]: unknown;
}
