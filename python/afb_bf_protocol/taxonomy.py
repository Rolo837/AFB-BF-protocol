...
MESSAGE_REGISTRY: dict[str, MessageMeta] = {
    ...
    "broker.get_accounts": MessageMeta("user", "afb2bf", "broker", "get_accounts"),
    ...
    "broker.accounts": MessageMeta("user", "bf2afb", "broker", "accounts"),
    ...
    "broker.error": MessageMeta("user", "bf2afb", "broker", "error"),
